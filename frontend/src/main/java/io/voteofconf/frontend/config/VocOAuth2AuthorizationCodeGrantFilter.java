 ...
 */
@Slf4j
public class VocOAuth2AuthorizationCodeGrantFilter extends OncePerRequestFilter {
     ...
     */
    public VocOAuth2AuthorizationCodeGrantFilter(ClientRegistrationRepository clientRegistrationRepository,
